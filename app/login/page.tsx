              ...
              <div className="mx-auto w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="border-border bg-[#27272a] block w-full rounded-lg border py-3 pr-3 pl-10 text-sm"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="border-border bg-[#27272a] block w-full rounded-lg border py-3 pr-12 pl-10 text-sm"
                  ...
                  <div className="relative text-center text-sm text-stone-500">
                    <span className="relative px-2 text-[#e6e1d7]">
                      Or continue with
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      type="button"
                      className="border-border bg-[#27272a] text-[#e6e1d7] hover:bg-secondary/80 flex items-center justify-center rounded-lg border px-4 py-2.5 text-sm shadow-sm"
                    >
                      <img
