...
import SideNavigation from "../component/side-navigation";
...
export default function MinimalHero() {
  ...
  return (
    <div className="font-primary relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-[#1a1d18] via-black to-[#2a2e26] text-[#e6e1d7]">
      ...
      {/* Floating elements (still background) */}
      <div
      ...
      {/* Mouse gradient - still background-ish, but fixed */}
      <div
        id="mouse-gradient"
        ref={gradientRef}
      ...
      {/* === TOP LAYER: NAV + PAGE CONTENT === */}
      {/* Side nav always on top */}
    </div>
  );
}
